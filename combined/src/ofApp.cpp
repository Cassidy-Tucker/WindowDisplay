...
//    gui.add(draw_depth.set("Draw Depth", false));
    gui.add(draw_contours.set("Draw w Boxes", false));
    gui.add(draw_polylines.set("Draw Polylines", false));
//    gui.add(draw_mesh.set("Draw mesh", true));
    gui.add(draw_tri_meshes.set("Draw Triangles", false));
    gui.add(draw_vertices.set("Draw Circles", false));
...
void ofApp::update(){
    ...
    rainbowFbo.begin();
        rainbowShader.begin();
    rainbowShader.setUniformTexture("tex0",outputFbo.getTexture(), 1);
        outputFbo.draw(0, 0);
        rainbowShader.end();
    rainbowFbo.end();
//    depthFbo.begin();
